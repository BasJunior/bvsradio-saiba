...
export default function CreateServicePage() {
  return (
    <main className="mx-auto max-w-3xl px-5 pb-20 pt-10 sm:px-6 sm:pt-12">
      <StudioCreateAnalytics intent="service" />
      ...
      <p className="mt-3 max-w-2xl text-sm leading-6 text-text-secondary sm:text-base">
        Tell BVS what you offer, including recording and studio sessions. If you have not set up a client-facing profile yet, we only ask for the essentials first.
      </p>
      <div className="mt-8">
        <QuickServiceCreate />
      </div>
