...
export default function ArtistsPage() {
  ...
  return <main className="mx-auto max-w-7xl px-6 py-12">
    <div className="flex flex-wrap items-end justify-between gap-5"><div><p className="text-xs uppercase tracking-[0.22em] text-brand">For creators</p><h1 className="mt-2 text-4xl font-semibold">Wallet & earnings</h1><p className="mt-3 max-w-3xl text-text-secondary">See what you sold, what BVS earned, payment processing, refunds, and the amount that actually remains for payout.</p></div><div className="flex flex-wrap gap-2"><Link href="/upload" className="rounded-full border border-white/20 px-5 py-2 text-sm hover:border-brand">Submit music / beats</Link><Link href="/premium" className="rounded-full border border-brand/40 px-5 py-2 text-sm text-brand hover:bg-brand/10">Compare Premium</Link></div></div>
