    ...
    <div className="mx-auto max-w-5xl px-6 py-14">
      ...
      <section className="mt-8 grid gap-10 md:grid-cols-[minmax(0,1fr)_minmax(18rem,.8fr)]">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link
              ...
              className="rounded-xl bg-brand px-5 py-3 font-semibold text-black"
            >
              Watch live
            </Link>
            <Link
          ...
          <dl className="mt-8 grid gap-5 rounded-xl border border-white/10 bg-white/[.03] p-6 sm:grid-cols-2">
            <div>
          ...
          <div className="mt-8 rounded-xl border border-white/10 p-5">
            ...
            <p className="mt-2 text-sm text-text-secondary">
              We will publish real recordings, guest details and track information
              after production begins. No filler episodes or invented play counts.
            </p>
          </div>
        </div>
        <div className="relative aspect-square overflow-hidden rounded-xl border border-white/10">
          <Image
            src={show.image}
            alt={`${show.title} programme artwork`}
            fill
            priority
