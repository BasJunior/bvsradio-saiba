...
export const discoveryItems: DiscoveryItem[] = [
  ...
  { id: 'artist-wolfbridges', kind: 'artist', title: 'Wolfbridges', subtitle: 'Artist projects on BVS Radio', href: '/artist/wolfbridges', image: '/images/albums/straightenin.jpg', tags: ['artist', 'streaming', 'projects'] },
