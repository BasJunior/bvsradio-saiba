...
export const discoveryItems: DiscoveryItem[] = [
  ...
  { id: 'album-straightenin', kind: 'track', title: 'STRAIGHTENIN', subtitle: 'Wolfbridges · Streaming release', href: '/catalogue?q=STRAIGHTENIN', image: '/images/albums/straightenin.jpg', tags: ['album', 'streaming', 'Wolfbridges'] },
  { id: 'album-howling-in-the-hills', kind: 'track', title: 'HOWLING IN THE HILLS 2', subtitle: 'Wolfbridges x W.Hills · Streaming release', href: '/catalogue?q=HOWLING%20IN%20THE%20HILLS', image: '/images/albums/howling-in-the-hills-2.jpg', tags: ['album', 'streaming', 'W.Hills'] },
  { id: 'album-wolf-been-bad', kind: 'track', title: 'WOLF BEEN BAD', subtitle: 'Wolfbridges x I Ratty · Streaming release', href: '/catalogue?q=WOLF%20BEEN%20BAD', image: '/images/albums/wolf-been-bad.jpg', tags: ['album', 'streaming', 'I Ratty'] },
  ...
  { id: 'artist-wolfbrx', kind: 'artist', title: 'WolfBrx', subtitle: 'Producer on BVS Radio', href: '/artist/wolf-bridges', image: '/images/music-packs/june-pack.jpg', tags: ['artist', 'producer', 'beats'] },
  { id: 'artist-wolfbridges', kind: 'artist', title: 'Wolfbridges', subtitle: 'Artist projects on BVS Radio', href: '/artist/wolf-bridges', image: '/images/albums/straightenin.jpg', tags: ['artist', 'streaming', 'projects'] },
