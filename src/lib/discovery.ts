...
export const discoveryItems: DiscoveryItem[] = [
  ...
  { id: 'album-straightenin', kind: 'track', title: 'STRAIGHTENIN', subtitle: 'Wolfbridges · Spotify release', href: '/catalogue?q=STRAIGHTENIN', image: '/images/musicians.jpg', tags: ['album', 'Spotify', 'Wolfbridges'] },
  { id: 'album-howling-in-the-hills', kind: 'track', title: 'HOWLING IN THE HILLS 2', subtitle: 'Wolfbridges x W.Hills · Spotify release', href: '/catalogue?q=HOWLING%20IN%20THE%20HILLS', image: '/images/editorial/music-discovery-show.webp', tags: ['album', 'Spotify', 'W.Hills'] },
  { id: 'album-wolf-been-bad', kind: 'track', title: 'WOLF BEEN BAD', subtitle: 'Wolfbridges x I Ratty · Spotify release', href: '/catalogue?q=WOLF%20BEEN%20BAD', image: '/images/festival-crowd.jpg', tags: ['album', 'Spotify', 'I Ratty'] },
  ...
  { id: 'artist-wolfbridges', kind: 'artist', title: 'Wolfbridges', subtitle: 'Artist projects on BVS Radio', href: '/artist/wolfbridges', image: '/images/musicians.jpg', tags: ['artist', 'Spotify', 'projects'] },
