...
export default function AppExploreClient({ surface }: { surface: AppSurface }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 pb-10 pt-6 sm:px-6">
      ...
      <div className="mt-10 rounded-2xl border border-white/10 bg-white/[.025] p-5 text-sm text-text-secondary">Looking for something deeper? <Link href="/search" className="font-semibold text-brand">Open full BVS search →</Link></div>
    </div>
  );
}
