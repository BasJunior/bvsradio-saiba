...
/**
 * iOS-stable listen panel.
 *
 * Forked from the web HomeListenPanel so ordinary website home/player chrome
 * edits do not silently reshape the installed App Store listen surface.
      ...
      <div className="p-4 sm:p-6">
        <div className="flex items-center gap-3 sm:gap-4">
          <button
            ...
            className="relative h-16 w-16 shrink-0 overflow-hidden rounded-xl border border-white/10 bg-white/[0.06] sm:h-20 sm:w-20 sm:rounded-2xl"
