  ...
  return (
    <form onSubmit={submit} className="space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <button disabled={busy} className="rounded-full bg-brand px-6 py-3 font-semibold text-black disabled:opacity-50">
          {busy ? "Working…" : "Send beat to BVS"}
        </button>
        <Link href="/creator/studio" className="rounded-full border border-white/15 px-5 py-3 text-sm">Cancel</Link>
