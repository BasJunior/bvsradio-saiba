      ...
      {!approved ? (
        <form onSubmit={submitSimpleProfile} className="rounded-3xl border border-white/10 bg-white/[.02] p-5 sm:p-6">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <button disabled={busy || profileStatus === "submitted" || profileStatus === "in_review"} className="rounded-full bg-brand px-5 py-2.5 font-semibold text-black disabled:opacity-50">
        ...
        <form onSubmit={submitService} className="rounded-3xl border border-white/10 bg-white/[.02] p-5 sm:p-6">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <button disabled={busy} className="rounded-full bg-brand px-5 py-2.5 font-semibold text-black disabled:opacity-50">{busy ? "Sending…" : "Send service to BVS"}</button>
