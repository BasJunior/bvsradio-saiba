    ...
    <footer className="mt-20 border-t border-white/10 bg-bg-secondary/50">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="mb-10 max-w-2xl">
          <p className="text-[10px] font-semibold uppercase tracking-[.2em] text-[#d8b36a]">Best Virtual Sound</p>
          <h3 className="mt-2 text-2xl font-semibold">One BVS for listening, discovery and creator work.</h3>
          <p className="mt-3 text-sm leading-relaxed text-text-secondary">BVS Radio connects live rotation, artists, shows, BeatStore, Marketplace, Creator Studio and Library without splitting the experience into competing service systems.</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/catalogue" className="text-sm text-text-secondary transition-colors hover:text-brand">Music &amp; BeatStore</Link>
          ...
          <div>
            <h4 className="mb-3 text-sm font-semibold text-text-primary">Create &amp; work</h4>
            <div className="flex flex-col gap-2">
              ...
              <Link href="/upload?type=beats" className="text-sm text-text-secondary transition-colors hover:text-brand">Submit beat</Link>
              <Link href="/creator/marketplace" className="text-sm text-text-secondary transition-colors hover:text-brand">Manage provider store</Link>
              <Link href="/premium" className="text-sm text-text-secondary transition-colors hover:text-brand">Premium</Link>
            </div>
          </div>

          <div>
            <h4 className="mb-3 text-sm font-semibold text-text-primary">Marketplace &amp; keep</h4>
            <div className="flex flex-col gap-2">
              ...
              <Link href="/library" className="text-sm text-text-secondary transition-colors hover:text-brand">Library</Link>
              <Link href="/checkout" className="text-sm text-text-secondary transition-colors hover:text-brand">Cart</Link>
            </div>
          </div>

          <div>
            <h4 className="mb-3 text-sm font-semibold text-text-primary">Company &amp; support</h4>
            <div className="flex flex-col gap-2">
