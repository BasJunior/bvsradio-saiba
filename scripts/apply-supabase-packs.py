...
PACKS: list[dict[str, str | int]] = [
    ...
    {"id": "producer-collaboration", "step": 11, "file": "supabase-producer-collaboration.sql"},
    {"id": "profile-role-applications", "step": 12, "file": "supabase-profile-role-applications.sql"},
    ...
    {"id": "artwork-change-requests", "step": 29, "file": "supabase-artwork-change-requests.sql"},
    {"id": "flow-v2-measurement", "step": 30, "file": "supabase-flow-v2-measurement.sql"},
    {"id": "flow-v2-activity", "step": 31, "file": "supabase-flow-v2-activity.sql"},
    {"id": "flow-v2-shows", "step": 32, "file": "supabase-flow-v2-shows.sql"},
    {"id": "payout-requests", "step": 33, "file": "supabase-payout-requests.sql"},
    {"id": "role-public-names", "step": 34, "file": "supabase-role-public-names.sql"},
]
