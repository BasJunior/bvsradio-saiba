...
-- Community routes authenticate the caller and mediate access server-side.
-- Do not inherit default public table grants on a new beta table.
REVOKE ALL ON public.community_blocks FROM PUBLIC, anon, authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.community_blocks TO service_role;
